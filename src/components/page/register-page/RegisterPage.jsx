  ...
  return (
    <div>
      ...
      <form className={style.form} onSubmit={hundleSubmit}>
        ...
        <input type="name" className={style.input} id={idName} name="name" value={name} onChange={hundleChang}/>
        <label className={style.label} htmlFor={idEmail}>
          Email
        </label>{' '}
        <input type="email" className={style.input} id={idEmail} name="email" value={email} onChange={hundleChang}/>
        <label className={style.label} htmlFor={idPAssword}>
          Password
        </label>{' '}
        <input type="password" className={style.input}  id={idPAssword} name="password" value={password} onChange={hundleChang}/>
